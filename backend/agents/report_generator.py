...
class ReportGeneratorAgent(BaseAgent):
    def run(self, context: Dict[str, Any], params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        summary = self._summary(data, measure)
    ...
    def _follow_up_suggestions(
        ...
        suggestions = []
        dim_map = {"region": "region", "country": "country", "category": "category", "segment": "segment"}
        other_dims = [d for d in ["region", "country", "category", "segment"] if d != dim]
